...
if (true) {
    if(isset($_POST['submit'])) {
        ...
        if(!in_array($extension, $allowed_extensions)) {
            ...
            // To make changeimage2.php, change Image1 to Image2 here:
            $query = mysqli_query($conn, "UPDATE tblproducts SET Image1='$images' WHERE ID='$eid'");
            
            if ($query) {
                $_SESSION['success_msg'] = "Product Image 1 has been updated successfully.";
                ...
                <div class="card-body">
                    <form method="post" enctype="multipart/form-data" class="confirm-submit" data-confirm-message="Are you sure you want to change this image?">
                        ...
                        <div class="mb-4 text-center border p-3 rounded">
                            ...
                            <img src="../uploads/products/<?php echo $row['Image1'];?>" class="img-fluid rounded shadow-sm" style="max-height: 200px;">
                        </div>
