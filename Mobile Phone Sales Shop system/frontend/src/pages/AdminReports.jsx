...
export default function AdminReports() {
  ...
  const reportCards = [
    {
      title: 'Daily Sales & Financials',
      desc: 'Billed revenue, cost price, payment modes, and net profit margins.',
    ...
    },
    {
      ...
      desc: 'Track days unsold, slow-moving stock, and critical dead-stock items.',
      icon: <Package size={24} />,
      iconBg: 'rgba(239,68,68,0.15)',
      iconColor: 'var(--danger)',
      stat: stats ? `${stats.totalStock} units` : '—',
      statLabel: 'Total Stock Units',
      href: '/admin/reports/inventory-aging',
      adminOnly: true
    },
    {
      title: 'Profit Margin & Markup',
      desc: 'Track buying cost vs retail price, unit profits, and high/low margin tiers.',
      icon: <TrendingUp size={24} />,
      iconBg: 'rgba(16,185,129,0.15)',
      iconColor: '#10b981',
      stat: stats ? 'Inspected' : '—',
      statLabel: 'Catalog Markup',
      href: '/admin/reports/profit-margins',
      adminOnly: true
    },
    {
      title: 'Customer Behavior',
      desc: 'Customer spend leaderboards, order frequency, and brand preferences.',
      icon: <Users size={24} />,
      iconBg: 'rgba(6,182,212,0.15)',
      iconColor: 'var(--secondary)',
      stat: stats ? `${stats.totalCustomers} accounts` : '—',
      statLabel: 'Registered Clients',
      href: '/admin/reports/customer-behavior',
      adminOnly: false
    },
    {
      title: 'Brand Performance',
      desc: 'Units sold, sales revenue, net profit, and warranty return claims by product.',
      icon: <Star size={24} />,
      iconBg: 'rgba(245,158,11,0.15)',
      iconColor: '#f59e0b',
      stat: stats?.bestBrand || 'N/A',
      statLabel: 'Top Brand',
      href: '/admin/reports/brand-performance',
      adminOnly: true
    },
    {
      title: 'Staff Performance Evaluation',
      desc: 'Sales handled, repairs completed, revenue output, and client ratings.',
      icon: <ShieldCheck size={24} />,
      iconBg: 'rgba(156,163,175,0.15)',
      iconColor: 'var(--text-muted)',
      stat: stats ? `${stats.totalStaff} employees` : '—',
      statLabel: 'Active Staff',
      href: '/admin/reports/employee-performance',
      adminOnly: true
    },
    {
      ...
      statLabel: 'Month Revenue',
      href: '/admin/reports/seasonal-trends',
      adminOnly: false
    },
    {
      title: 'Geographic Regional Demand',
      desc: 'Order shipping locations, regional market share, and ticket averages.',
      icon: <MapPin size={24} />,
      iconBg: 'rgba(255,255,255,0.05)',
      iconColor: 'var(--text-muted)',
      stat: stats?.topLocation || 'N/A',
      statLabel: 'High Demand Area',
      href: '/admin/reports/geographic-distribution',
      adminOnly: false
    }
  ];
